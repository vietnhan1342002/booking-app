...
class VillaWidget extends StatefulWidget {
  const VillaWidget({Key? key, required int categoryIndex}) : super(key: key);
  @override
  State<StatefulWidget> createState() => _VillaWidget();
}

class _VillaWidget extends State<VillaWidget> {
